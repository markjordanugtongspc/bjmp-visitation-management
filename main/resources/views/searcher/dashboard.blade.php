        ...
        <div class="flex-1 min-h-screen bg-gray-50 dark:bg-gray-950">
                ...
                <div class="h-14 sm:h-16 px-3 sm:px-4 flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 ml-auto">
                        ...
                        <button data-user-menu
                          ...
                          data-user-role="{{ Auth::user()->title ?? 'Searcher' }}"
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                    <!-- Line Chart - Weekly Visitor Traffic -->
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800 lg:col-span-2">
                        ...
                        <div class="mt-3" data-chart="weekly-line">
                            <!-- Chart will be dynamically generated by chart.js -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-600 dark:text-gray-300">Total Visitors</div>
                            <span class="inline-flex items-center rounded-full bg-blue-500/10 text-blue-500 px-2 py-0.5 text-[11px]">Live</span>
                        </div>
                        <div id="stat-total-visitors" class="mt-2 text-2xl font-semibold text-gray-900 dark:text-gray-50">
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800">
                        ...
                        <div id="stat-today-visits" class="mt-2 text-2xl font-semibold text-gray-900 dark:text-gray-50">
                            <div class="inline-flex items-center">
                                <svg class="animate-spin h-5 w-5 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    <a href="{{ route('searcher.visitors.index') }}" id="register-allowed-visitor-btn" class="group rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800 hover:border-blue-500">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-50">Register Allowed Visitor</div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Add to approved list</div>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('searcher.visitors.requests') }}" id="new-manual-registration-btn" class="group rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800 hover:border-blue-500">
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600 dark:text-gray-400">Create manual request</div>
                            </div>
                        </div>
                    </a>
                    <a href="{{ url('/searcher/visitors') }}" class="group rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800 hover:border-blue-500">
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center">
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-50">Visitors Management</div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Review and update requests</div>
                            </div>
                        </div>
                    </a>
                ...
                <!-- Recent Requests + Schedules (static for now) -->
                <div class="mt-4 grid grid-cols-1 xl:grid-cols-3 gap-4">
                    ...
                    <div class="xl:col-span-1 rounded-xl bg-white dark:bg-gray-900 shadow border border-gray-200 dark:border-gray-800">
                        ...
                        <div class="p-4 space-y-3 text-sm text-gray-700 dark:text-gray-200" data-schedules-container>
                            <!-- Schedules will be dynamically loaded by chart.js -->
