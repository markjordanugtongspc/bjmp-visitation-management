...
<body class="dark bg-white dark:bg-slate-900 text-[#1b1b18] min-h-screen">
    <!-- Header Navigation -->
    <header class="fixed top-0 inset-x-0 z-[100] w-full transition-all duration-300" id="navbar" style="background-color: #00002B;">
        <nav class="container mx-auto flex items-center justify-between h-24 px-4 md:px-6 bg-[#00002B] w-full">
            <!-- Brand -->
            <div class="flex items-center gap-4 bg-transparent dark:bg-transparent backdrop-blur-0 rounded-xl p-2.5 md:p-3 border-0 transition-all duration-300">
                ...
                <div class="block">
                    <h2 class="text-lg md:text-xl lg:text-2xl font-bold text-white dark:text-white tracking-tight">BJMP</h2>
                    <p class="text-xs md:text-sm text-gray-200 dark:text-gray-300 font-medium">Iligan City</p>
                </div>
            </div>

            <!-- Navigation Menu -->
            <div class="hidden md:flex items-center space-x-16">
                <a href="{{ url('/') }}" class="text-white group relative px-4 py-3 text-lg font-semibold tracking-wide transition-all duration-300 ease-in-out hover:scale-110 hover:-translate-y-0.5 transform-gpu">
                ...
                <a href="{{ url('/about') }}" class="text-white group relative px-4 py-3 text-lg font-semibold tracking-wide transition-all duration-300 ease-in-out hover:scale-110 hover:-translate-y-0.5 transform-gpu">
                    <span class="relative z-10 group-hover:text-blue-200 transition-colors duration-300 inline-block">About Us</span>
                    <span class="absolute inset-x-0 bottom-0 h-0.5 bg-white transform origin-bottom scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                    <span class="absolute inset-0 rounded-lg bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                </a>
                <a href="{{ url('/features') }}" class="text-white group relative px-4 py-3 text-lg font-semibold tracking-wide transition-all duration-300 ease-in-out hover:scale-110 hover:-translate-y-0.5 transform-gpu">
                    <span class="relative z-10 group-hover:text-blue-200 transition-colors duration-300 inline-block">Features</span>
                    <span class="absolute inset-x-0 bottom-0 h-0.5 bg-white transform origin-bottom scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                    <span class="absolute inset-0 rounded-lg bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                </a>
                <a href="{{ url('/contact') }}" class="text-white group relative px-4 py-3 text-lg font-semibold tracking-wide transition-all duration-300 ease-in-out hover:scale-110 hover:-translate-y-0.5 transform-gpu">
