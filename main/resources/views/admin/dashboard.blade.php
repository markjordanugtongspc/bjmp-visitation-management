            ...
            <header class="">
                <div class="h-14 sm:h-16 px-3 sm:px-4 flex items-center gap-3">
                 <!-- Mobile: sidebar toggle (hamburger icon) -->
                    <button data-sidebar-toggle class="sm:hidden inline-flex items-center justify-center rounded-md border border-gray-200 dark:border-gray-700 h-9 w-9 text-gray-700 dark:text-gray-300 hidden sm:block">
                ...
                <div class="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800 lg:col-span-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-[11px] text-gray-500 dark:text-gray-400" data-year-label>2025</span>
                        </div>
                        <div class="mt-3" data-chart="monthly-bar">
                            <!-- Chart will be dynamically generated by chart.js -->
                            <div class="flex items-center justify-center h-48">
                                <svg class="animate-spin h-8 w-8 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    ...
                    <!-- Cells Capacity -->
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-4 shadow border border-gray-200 dark:border-gray-800">
                        <div class="text-sm font-medium text-gray-900 dark:text-gray-50">Cells Capacity</div>
                        <div class="mt-3 space-y-3" data-capacity-container>
                            <!-- Capacity data will be dynamically loaded by chart.js -->
                            <div class="flex items-center justify-center py-8">
                                <svg class="animate-spin h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 714 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
