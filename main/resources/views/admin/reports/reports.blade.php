            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <button id="reports-refresh-btn" 
                                    class="group flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer">
                                <svg class="w-4 h-4 group-hover:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                </svg>
                    ...
                    <div class="flex flex-wrap items-center gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Quick ranges:</span>
                        <button class="quick-range-btn cursor-pointer px-3 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1" data-days="7">
                            Last 7 days
                        </button>
                        <button class="quick-range-btn cursor-pointer px-3 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1" data-days="30">
                            Last 30 days
                        </button>
                        <button class="quick-range-btn cursor-pointer px-3 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1" data-days="90">
                            Last 90 days
                        </button>
                        <button class="quick-range-btn cursor-pointer px-3 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1" data-days="365">
                            Last year
                        </button>
                    </div>
                </div>
                ...
                <!-- Charts Section -->
                <div class="w-full mt-4 mb-6"><!-- Add `mt-4` for a small top margin -->
                        ...
                        <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-5 md:p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Facility Overview</h3>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">Current occupancy status</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-5 md:space-y-6">
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <span class="text-lg font-bold text-gray-900 dark:text-white">{{ $facilityOverview['occupancyRate'] }}%</span>
                                    </div>
                                    <div class="relative">
                                        <div class="bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                                            <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-3 rounded-full transition-all duration-500 ease-out" 
                                                 style="width: {{ $facilityOverview['occupancyRate'] }}%"></div>
                                        </div>
                                ...
                                <div class="grid grid-cols-3 gap-3 md:gap-4">
                                    <div class="text-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                        <p class="text-xl md:text-2xl font-bold text-red-600 dark:text-red-400">{{ $facilityOverview['occupied'] }}</p>
                                        <p class="text-xs md:text-sm text-red-600 dark:text-red-400 font-medium">Occupied</p>
                                    </div>
                                    <div class="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                        <p class="text-xl md:text-2xl font-bold text-green-600 dark:text-green-400">{{ $facilityOverview['available'] }}</p>
                                        <p class="text-xs md:text-sm text-green-600 dark:text-green-400 font-medium">Available</p>
                                    </div>
                                    <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <p class="text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $facilityOverview['capacity'] }}</p>
                                        <p class="text-xs md:text-sm text-blue-600 dark:text-blue-400 font-medium">Capacity</p>
                                    </div>
                                </div>

                                <!-- Additional Stats -->
                                @if(isset($facilityOverview['cells']))
                                <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">Cell Distribution</p>
                                    <div class="grid grid-cols-2 gap-3">
                                        @foreach($facilityOverview['cells'] as $cellType => $count)
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm text-gray-600 dark:text-gray-400">{{ ucfirst($cellType) }}</span>
