            ...
            <div class="p-4 sm:p-6">
                <div class="rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow">
                    <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                        ...
                        <button type="button" class="inline-flex items-center gap-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 text-xs sm:text-sm cursor-pointer" data-add-officer data-store-url="{{ route('assistant-warden.officers.store') }}" data-update-url="{{ route('assistant-warden.officers.update', ['user' => 0]) }}" data-list-url="{{ route('assistant-warden.officers.list') }}" data-csrf="{{ csrf_token() }}">
