<x-app-layout>
    <div class="flex">
        ...
        <!-- Main content -->
        <div class="flex-1 min-h-screen bg-gray-50 dark:bg-gray-950" data-route-admin-inmates-male="{{ route('assistant-warden.inmates.index') }}" data-route-admin-inmates-female="{{ route('assistant-warden.inmates.female') }}" data-current-gender="male">
