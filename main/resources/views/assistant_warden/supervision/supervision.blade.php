<x-app-layout>
    ...
    <div class="flex-1 min-h-screen bg-white dark:bg-gray-950" 
         data-upload-url="{{ route('assistant-warden.supervision.upload') }}"
         data-list-url="{{ route('assistant-warden.supervision.index') }}"
         data-preview-url="{{ route('assistant-warden.supervision.preview', ':id') }}"
